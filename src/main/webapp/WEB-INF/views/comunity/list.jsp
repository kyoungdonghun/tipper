...
<style>
	...
	<div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
		<div class="carousel-inner">
			...
			<div class="carousel-item">
	            <div class="d-flex">
	             <c:forEach items="${eventlist}" var="event" varStatus="loop">
	   				 <c:if test="${loop.index >= 2 && loop.index < 4}">
		                <div class="card" style="width: 100%;">
							<img src="${event.thumbnail}" alt="Event Thumbnail">
							<input type="hidden" name="id" value="${event.id }">
		                </div>
			...
			<div class="carousel-item">
	            <div class="d-flex">
	             <c:forEach items="${eventlist}" var="event" varStatus="loop">
	   				 <c:if test="${loop.index >= 4 && loop.index < 6}">
		                <div class="card" style="width: 100%;">
							<img src="${event.thumbnail}" alt="Event Thumbnail">
							<input type="hidden" name="id" value="${event.id }">
		                </div>
			...
			<div class="carousel-item">
	            <div class="d-flex">
	             <c:forEach items="${eventlist}" var="event" varStatus="loop">
	   				 <c:if test="${loop.index >= 6 && loop.index < 8}">
		                <div class="card" style="width: 100%;">
							<img src="${event.thumbnail}" alt="Event Thumbnail">
							<input type="hidden" name="id" value="${event.id }">
		                </div>
			...
			<div class="carousel-item">
	            <div class="d-flex">
	             <c:forEach items="${eventlist}" var="event" varStatus="loop">
	   				 <c:if test="${loop.index >= 8 && loop.index < 10}">
		                <div class="card" style="width: 100%;">
							<img src="${event.thumbnail}" alt="Event Thumbnail">
							<input type="hidden" name="id" value="${event.id }">
		                </div>
    ...
    <button class="carousel-control-next" type="button" data-bs-target="#carouselExample" data-bs-slide="next">
        ...
        <span class="visually-hidden">Next</span>
	            ...
	            <div class="row">
	                <div class="col-lg-12">
	                    <h1 class="page-header">글 번호 정렬</h1>
	                </div>
	            </div>
	            <!-- /.row -->
	            <hr>
...
<div class="card2 mb-4"><hr>
 ...
 <script>
   ...
   $(".card").on("click", function(e){
	   ...
	   var cardText = $(this).find("input[name='id']").val();
	   // 이동할 링크 주소 설정
	    var link = "/lostark/get?id=" + cardText;
