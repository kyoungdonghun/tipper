            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <header class="mb-4">
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1">${listone.title }</h1>
...
<!-- Post meta content-->
<div class="text-muted fst-italic mb-2 text-end">${listone.createdate}</div>
<!-- Post categories-->
<div class="d-flex justify-content-end">
    ...
    <a class="badge bg-secondary text-decoration-none link-light" href="#!">댓글수 : ${listone.replycount}</a>
                        ...
                        <section class="mb-5" style="min-height: 300px;">
                            <p class="fs-5 mb-4">${listone.comunitytext }</p>
                        </section>
                    </article>
					            ...
					            <c:choose>
						            ...
						            <c:when test="${pageContext.request.userPrincipal.name != null }">
										...
										<input type="hidden" name="${_csrf.parameterName }" value="${_csrf.token }"/>
										    ...
										    <input type="hidden" name="postid" value="${listone.comunitynumber}">
										    <input type="hidden" name="post_type" value="COMUNITY">
...
$(document).ready(function(){
	...
	(function(){
		var postid = '<c:out value="${listone.comunitynumber}"/>';
		var post_type='<c:out value="${listone.post_type}"/>';
		
		$.getJSON("/comunity/getAttachList",{comunitynumber:postid,post_type:post_type},function(arr){
			console.log(arr);
		});
	})();
	 var cnValue = '<c:out value="${listone.comunitynumber}"/>';
	    var ptValue = '<c:out value="${listone.post_type}"/>';
	    var replyUL = $(".chat");
	    showList(1);
